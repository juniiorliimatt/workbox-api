...
-- precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM workbox.roles WHERE authority IN ('ADMIN', 'USER')
-- rollback DELETE FROM workbox.roles WHERE authority IN ('ADMIN', 'USER');
INSERT INTO workbox.roles (authority, created_at, created_by, updated_at, updated_by)
...
-- preconditions onFail:MARK_RAN onError:HALT
-- precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM workbox.users_api WHERE username IN ('admin', 'user');
INSERT INTO workbox.users_api (id, username, password, is_enabled, is_account_non_expired,
...
VALUES ('c269e6c8-ed9a-4204-9e84-96414776b21a', 'admin',
       ...
       ('d310d667-3eb9-46cc-84fc-e538ec65e8b3', 'user',
        ...
        current_timestamp, 'API', current_timestamp, 'API');
-- rollback DELETE FROM workbox.users_api WHERE id IN ('c269e6c8-ed9a-4204-9e84-96414776b21a', 'd310d667-3eb9-46cc-84fc-e538ec65e8b3');
...
-- preconditions onFail:MARK_RAN onError:HALT
-- precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM workbox.user_roles WHERE user_id IN ('c269e6c8-ed9a-4204-9e84-96414776b21a', 'd310d667-3eb9-46cc-84fc-e538ec65e8b3');
INSERT INTO workbox.user_roles (user_id, role_id)
VALUES ('c269e6c8-ed9a-4204-9e84-96414776b21a', 1),
       ('d310d667-3eb9-46cc-84fc-e538ec65e8b3', 2);
-- rollback DELETE FROM workbox.user_roles WHERE user_id IN ('c269e6c8-ed9a-4204-9e84-96414776b21a', 'd310d667-3eb9-46cc-84fc-e538ec65e8b3');
